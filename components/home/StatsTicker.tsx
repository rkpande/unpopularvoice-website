      ...
      >
        {doubled.map((item, i) => (
          <span key={i} className="inline-flex items-baseline gap-2 px-5 py-2.5 flex-shrink-0">
            <span className="font-sans text-[9px] font-bold text-white/35 uppercase tracking-widest">
              {item.company}
            </span>
            <span className="font-serif text-white text-sm font-bold">
              {item.value}
            </span>
            <span className="font-sans text-white/35 text-[9px] uppercase tracking-wider">
              {item.label}
            </span>
